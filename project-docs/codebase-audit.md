...
- Exact responsive profile dimensions/formats: 12 profile outputs at or below 122,880 bytes.
...
- Tracked deployment smoke checks for the Pages site, all sitemap routes, robots, sitemap, icon, social image, and a research asset; these run after the next deployment.
...
- The production build exported the retained static routes, and asset checks passed for all 12 profile outputs.
- Playwright semantic coverage ran across Chromium desktop/mobile, Firefox, and WebKit, with visual and accessibility coverage for sitemap routes.
...
- Add research through validated `.md` front matter.
